      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-9 pt-20 sm:px-8 sm:pb-10 sm:pt-28">
        ...
        >
          ...
          >
            ...
            <br className="hidden sm:block" /> {t.footer.headingLine2}
          </motion.h2>
        ...
        >
          ...
          <motion.div variants={fadeUp} custom={1}>
            <span className="annotation text-bone/40">{t.footer.navTitle}</span>
          ...
          <motion.div variants={fadeUp} custom={2}>
            <span className="annotation text-bone/40">{t.footer.contactTitle}</span>
            <ul className="mt-5 flex flex-col gap-3">
              <li>
                <a
          ...
          <motion.div variants={fadeUp} custom={3}>
            <span className="annotation text-bone/40">{t.footer.hoursTitle}</span>
            <ul className="mt-5 flex flex-col gap-3 text-sm text-bone/80">
              <li className="flex items-center justify-between gap-4">
                <span className="text-bone-dim">{t.footer.hours.weekdays}</span>
                <span>{t.footer.hours.weekdayHours}</span>
              </li>
              <li className="flex items-center justify-between gap-4">
                <span className="text-bone-dim">{t.footer.hours.weekend}</span>
        ...
        <div className="mt-12 flex flex-col-reverse items-center gap-5 border-t border-bone/10 pt-7 sm:mt-16 sm:flex-row sm:justify-between sm:gap-6 sm:pt-8">
          <p className="text-center text-xs text-bone-dim/70 sm:text-left">
            © {year} NEGRA DESIGN. {t.footer.copyright}
          </p>
